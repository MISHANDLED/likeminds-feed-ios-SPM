//
//  LMFeedBaseSearchPostViewModel.swift
//  LikeMindsFeedCore
//
...
public class LMFeedBaseSearchPostViewModel {
    // MARK: Data Variables
    var timer: Timer?
    unowned var delegate: LMFeedBaseSearchPostViewModelProtocol
    ...
    init(delegate: LMFeedBaseSearchPostViewModelProtocol) {
        self.timer = nil
...
extension LMFeedBaseSearchPostViewModel {
...
// MARK: Delete Post
public extension LMFeedBaseSearchPostViewModel {
